...
//     <section
//       id="features"
//       className="relative overflow-hidden bg-[#F8F6FF] py-16 dark:bg-[#0B0B10] sm:py-24"
//     >
//       <Container>
...
//         <div className="mt-16 grid lg:gap-[124px] gap-20">
...
//                     <h3 className="text-2xl font-semibold tracking-[-0.02em] text-ink dark:text-white sm:text-[22px]">
//                       {row.title}
//                     </h3>
...
//                         <div
//                           key={bullet}
//                           className="flex items-center rounded-[42px] bg-black/[0.035] px-5 py-3 text-base font-light text-black/70 dark:bg-white/[0.055] dark:text-white/70 sm:text-lg"
//                         >
//                           <span>{bullet}</span>
//                         </div>
//                       ))}
...
//                     {row.para && (
//                       <p className="mt-5 max-w-xl text-sm leading-7 text-black/55 dark:text-white/50 sm:text-base">
//                         {row.para}
//                       </p>
//                     )}
//                   </div>
